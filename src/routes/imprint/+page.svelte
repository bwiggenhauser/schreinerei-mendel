<div class="flex flex-col gap-4 px-4 text-sm text-center items-center">
	<h1 class="font-bold text-center text-2xl mt-4">Impressum</h1>
	...
	<div>
		...
		<p>Telefon: 0751 - 2 34 79</p>
		<p>Fax: 0751 - 3662688</p>
		<p>E-Mail: schreinerei-mendel@t-online.de</p>
	</div>

	<div>
		<p class="font-bold">Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz:</p>
		<p>DE182928402</p>
	</div>

	<div>
		<p class="font-bold">Aufsichtsbehörde:</p>
		<p>Handwerkskammer Ulm/Tischler</p>
	</div>

	<div>
		<p class="font-bold text-xl">Haftungsausschluss</p>
	</div>

	<div>
		<p class="font-bold text-lg mb-1">Haftung für Inhalte</p>
		<p>
	...
	<div>
		<p class="font-bold text-lg mb-1">Urheberrecht</p>
		<p>
	...
	<div>
		<p class="font-bold text-lg mb-1">Datenschutz</p>
		<p>
